...
pub static BOOKMARK: &[u8] = include_bytes!("../../../assets/images/bookmark.svg");
pub static FILLED_BOOKMARK: &[u8] = include_bytes!("../../../assets/images/bookmark-filled.svg");
pub static SETTINGS: &[u8] = include_bytes!("../../../assets/images/settings.svg");
pub static SWITCH: &[u8] = include_bytes!("../../../assets/images/switch.svg");
pub static FILE_ICON: &[u8] = include_bytes!("../../../assets/images/file.svg");
